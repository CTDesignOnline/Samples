...
namespace Controllers
{
    ...
    public class CheckoutController : MerchelloSurfaceContoller
    {
        ...
        public ActionResult SaveAddress(AddressModel model)
        {
            ...
            return RedirectToUmbracoPage(GetContentIdByContentName(ShipRateQuotePage));
        }
        ...
        public ActionResult SaveApprovedShipmentRateQuote(Guid shipMethodKey)
        {
            ...
            return RedirectToUmbracoPage(GetContentIdByContentName(PaymentInfoPage)); // Proceed to step 3
        }
        ...
        public ActionResult CustomerPurchaseAndProcessPayment()
        {
            ...
            if (!Basket.SalePreparation().IsReadyToInvoice()) return RedirectToUmbracoPage(GetContentIdByContentName(BasketPage));
        ...
        private ActionResult RenderConfirmationThankyou(IPaymentResult attempt, string customerEmail)
        {
            ...
            var receipt = Umbraco.TypedContent(GetContentIdByContentName(ReceiptPage));
